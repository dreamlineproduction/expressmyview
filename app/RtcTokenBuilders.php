...
class RtcTokenBuilders
{
    ...
    public static function buildTokenWithUid($appID, $appCertificate, $channelName, $uid, $role, $privilegeExpireTs){
        return RtcTokenBuilders::buildTokenWithUserAccount($appID, $appCertificate, $channelName, $uid, $role, $privilegeExpireTs);
    }
    ...
    public static function buildTokenWithUserAccount($appID, $appCertificate, $channelName, $userAccount, $role, $privilegeExpireTs){
        ...
        if(($role == RtcTokenBuilders::RoleAttendee) ||
            ($role == RtcTokenBuilders::RolePublisher) ||
            ($role == RtcTokenBuilders::RoleAdmin))
        {
