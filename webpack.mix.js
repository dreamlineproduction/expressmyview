...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/green-audio-player.js', 'public/js')
mix.copy('resources/js/emoji/config.js', 'public/js/emoji')
   .copy('resources/js/emoji/util.js', 'public/js/emoji')
   .copy('resources/js/emoji/jquery.emojiarea.js', 'public/js/emoji')
   .copy('resources/js/emoji/emoji-picker.js', 'public/js/emoji')
   .copy('resources/js/clipboard.js', 'public/js')
   .copy('resources/css/emoji/emoji.css', 'public/css')
mix.copyDirectory('resources/css/img','public/css/img')
mix.postCss('resources/css/spinkit.css', 'public/css')
    .postCss('resources/css/app.css', 'public/css')
    .postCss('resources/css/bootstrap-tagsinput.css', 'public/css')
    .postCss('resources/css/owl.carousel.min.css', 'public/css')
    .postCss('resources/css/owl.theme.default.min.css', 'public/css')
    .postCss('resources/css/green-audio-player.css', 'public/css')
    // .js('resources/js/bootstrap-tagsinput.js', 'public/js')
