...
function buildMap() {
  ...
  for (var i in Config.emoji_data) {
    for (var j = 0; j < Config.emoji_data[i][0].length; j++) {
      ...
      codes.push(Config.emoji_data[i][0][0]); // it is a map of {"colon smiley":"unicode char"}

      Config.map[Config.emoji_data[i][3][0]] = Config.emoji_data[i][0][0];
      Config.mapcolon[":" + Config.emoji_data[i][3][0] + ":"] = Config.emoji_data[i][0][0]; // it is a map of {"unicode char": "colon smiley"}
...
/***/ 13:
/*!********************************************!*\
  !*** multi ./resources/js/emoji/config.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/rudra/freelance/emv/expressmyview/resources/js/emoji/config.js */"./resources/js/emoji/config.js");
