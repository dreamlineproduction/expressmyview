...
$(function () {
    ...
    $('#upload_video').ajaxForm({
      ...
      success: function success(data, status, xhr) {
        ...
        if (xhr.status == 201) {
          ...
          $('.imagePreview').css('background-image', 'url(' + data.thumbnail + ')'); // var i       = 0;
          // var url     = '{img}';
  ...
  $('#comment_form').submit(function (e) {
    ...
    $('.delete-comment').click(function (e) {
      e.preventDefault();
      e.stopPropagation();
      var container = $(this).closest('.comment-single');
    });
  });
});
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\live_view\resources\js\podcast.js */"./resources/js/video.js");
