                                ...
                                <div class=" text-right video-edit">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('channel.edit', $channel->id) }}"><i
                                                    class="far fa-edit"></i> Edit Channel</a>
                                            <a class="dropdown-item delete" data-channel="{{ $channel->id }}"
                                                href="#"><i class="far fa-trash-alt"></i> Delete Channel</a>
