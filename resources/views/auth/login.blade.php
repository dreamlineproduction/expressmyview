                  ...
                  <div class="login-main-left">
                    ...
                    <form action="{{ route('login') }}" method="post" id="login_form">
                     ...
                     <div class="text-center mt-5">
                        <p class="light-gray">Don’t have an account? <a href="{{ route('register') }}">{{ __('Sign Up') }}</a></p>
                     </div>
					  
					  <div class="text-center mt-2">
                        <p class="light-gray">{{ __('Forgot Your Password?') }}? <a href="{{ route('password.request') }}">{{ __('Click Here') }}</a></p>
                     </div>

                     
					  
					  <div class="text-center mt-5">
                        <p class="light-gray"> <a href="{{ route('home') }}"><i class="fas fa-long-arrow-alt-left"></i> {{ __('Back to Home') }}</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-md-7">
