...
<div class="container-fluid pt-5 pb-5 upload">
    <div class="row">
        <div class="col-md-8 mx-auto text-center upload-video pt-5 pb-2 shadow-sm p-3 mb-5 bg-white rounded">
            <img class="img-fluid upld-icon mb-4" src="{{asset('img/upload-podcast.svg')}}" width="150"
                alt="Select Video files to upload"></a>
...
<div class="container-fluid upload-details d-none">
    ...
    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="channel" id="channel" class="form-control" required>
                                    ...
                                    <option value="{{ $channel->id }}"
                                        {{ $channel->id == $selectedChannel ? ' selected' : '' }}>{{ $channel->name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea rows="8" id="description" name="description" class="form-control"
                                    placeholder="A short description about the podcast" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="mt-2">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="comments_allowed"
                                            id="commentsAllowed" value="1" checked required>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Gaming, PS4" name="tags" id="tags" class="form-control"
        ...
        <div class="terms text-center">
            <p class="mb-0">
            <p class="mb-0">By submitting your videos to Express My View, you acknowledge that you agree to Our Terms of
