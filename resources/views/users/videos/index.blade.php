                ...
                <div class="video-card">
                    <div class="video-card-image">
                        ...
                        <a href="{{ route('podcast.show', $video->id) }}">
                            <img class="img-fluid" src="{{ url('/storage/podcast/thumbnail/' . $video->thumbnail) }}"
                                alt="{{ $video->title }}">
                        </a>
                                ...
                                <div class=" text-right video-edit">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="{{ route('podcast.delete', $video->id) }}"><i
                ...
                <div class="video-card">
                    <div class="video-card-image">
                        ...
                        <a href="{{ route('podcast.show', $audio->id) }}">
                            <img class="img-fluid" src="{{ url('/storage/podcast/thumbnail/' . $audio->thumbnail) }}"
                                alt="{{ $audio->title }}">
                        </a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('podcast.edit', $audio->id) }}"><i
                                                    class="far fa-edit"></i> Edit Video</a>
                                            <a class="dropdown-item" href="{{ route('podcast.delete', $audio->id) }}"><i
                                                    class="far fa-trash-alt"></i> Delete Video</a>
    ...
    <div class="video-block section-padding">
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="video-card">
                    <div class="video-card-image">
                        <a class="play-icon" href="{{ route('live-streams.view', $stream->id) }}"><i
                                class="fas fa-play-circle" aria-hidden="true"></i></a>
