                        ...
                        <div class="main-title">
                            <div class="btn-group float-right right-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="{{ route('podcast.index', ['type' => 'video', 'orderBy' => 'date']) }}"><i
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"
                                       href="{{ route('podcast.index', ['type' => 'audio', 'orderBy' => 'popularity']) }}"><i
                                                class="fas fa-fw fa-signal"></i> &nbsp; Viewed</a>
                                    <a class="dropdown-item" href="{{ route('podcast.index', ['type' => 'audio', 'orderBy' => 'date']) }}"><i
                                                class="fas fa-fw fa-times-circle"></i> &nbsp;
                                        Upload Date</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="video-card">
                                ...
                                <div class="video-card-body">
                                    ...
                                    <div class="video-view float-left">
                                        {{ formatViewsCount($audio->views, 1) }} views &nbsp;<i
                                                class="fas fa-calendar-alt"></i> {{ $audio->created_at->diffForHumans() }}
                                    </div>
