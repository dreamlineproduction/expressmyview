...
@section('content')
    <div class="container-fluid upload-details">
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="imgplace"
                     style="background-image: url('{{ url('/storage/podcast/thumbnail/' . $video->thumbnail) }}')"></div>
            </div>
        </div>
        <hr>
        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="channel" id="channel" class="form-control" required>
                                        @foreach($channels as $channel)
                                            <option value="{{ $channel->id }}"{{ $channel->id == $video->channel_id ? ' selected' : '' }}>{{ $channel->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="title" id="title" value="{{ $video->title }}" class="form-control"
                                           required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="license" id="license" class="custom-select" required>
                                        @foreach($licenses as $license)
                                            <option value="{{ $license->id }}"{{ $video->license_id == $license->id ? ' selected' : '' }}>{{ $license->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" name="comments_allowed"
                                                   ...
                                                   value="0" {{ $video->comments_allowed == 0 ? 'checked ' : '' }}>
