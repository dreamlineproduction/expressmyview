...
<div class="container-fluid upload-details">
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <div class="imgplace"
                style="background-image: url('{{ Storage::disk('s3')->url('public/podcast/thumbnail/' . $stream->thumbnail) }}')">
            </div>
        </div>
    </div>
    <hr>
                            ...
                            <div class="form-group">
                                ...
                                <select name="channel" id="channel" class="form-control" required>
                                    ...
                                    <option value="{{ $channel->id }}"
                                        {{ $channel->id == $stream->channel_id ? ' selected' : '' }}>
                                        {{ $channel->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Contrary to popular belief, Lorem Ipsum (2019) is not."
                                    name="title" id="title" value="{{ $stream->title }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="license" id="license" class="custom-select" required>
                                    ...
                                    <option value="{{ $license->id }}"
                                        {{ $stream->license_id == $license->id ? ' selected' : '' }}>
                                        {{ $license->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="comments_allowed"
                                            ...
                                            {{ $stream->comments_allowed == 0 ? 'checked ' : '' }}>
